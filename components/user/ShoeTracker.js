...
const ShoeTracker =  () => {
    const { translations: { ShoeTrackerjs: translated } } = useContext(TranslationContext);
    ...
    return(
        <View style={styles.box}>
            ...
            <TouchableOpacity style={styles.content}>
                ...
                <View style = {{justifyContent: 'center', alignItems: 'left', marginLeft: 10,}}>
                <  Text style={styles.contentText}>{translated.pleaseUseTracker}</Text>
                <  Text style={{fontSize : 15, color : '#888888'}}>{translated.startShoeTracker}</Text>
                </View>
            </TouchableOpacity>
        </View>
    );
