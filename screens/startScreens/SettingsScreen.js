...
export default function SettingsScreen({}) {
  ...
  const test = async () => {
    const result = await console.log("test");
  };
  return (
        ...
        <View style={styles.detailContainer}>
          ...
          <View style={styles.detailContent}>
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate("TypeSetting");
              }}
            >
            ...
            <TouchableOpacity
              style={styles.detailItem}
              onPress={() => navigation.navigate("RouteSetting")}
            >
              <View style={styles.optionItem1}>
        ...
        <View style={styles.detailContainer}>
          ...
          <View style={styles.optionContent}>
            ...
            >
              <View style={styles.optionItem1}>
                <Text style={styles.detailItemText}>
                  {translated.trackingMode}
                </Text>
              </View>
              <View style={styles.optionItem2}>
                <Text style={styles.optionText}>
                  {stopWatchMode ? translated.stopWatch : translated.gpsMode}
                </Text>
                <AntDesignIcon name="right" size={20} color="lightgray" />
              </View>
            </TouchableOpacity>
            <TouchableOpacity style={styles.detailItem}>
              <View style={styles.optionItem1}>
                <Text style={styles.detailItemText}>
                  {translated.liveTrackingFunction}
                </Text>
              </View>
              <View style={styles.optionItem2}>
            ...
            <TouchableOpacity
              style={styles.detailItem}
              onPress={() => {
                navigation.navigate("PocketTrackingSetting");
              }}
            >
              <View style={styles.optionItem1}>
                <Text style={styles.detailItemText}>
                  {translated.pocketTrack}
                </Text>
              </View>
              <View style={styles.optionItem2}>
                <Text style={styles.optionText}>
                  {withPocketTrack ? translated.on : translated.off}
                </Text>
                <AntDesignIcon name="right" size={20} color="lightgray" />
              </View>
            </TouchableOpacity>
        ...
        <View style={styles.detailContainer}>
          ...
          <View style={styles.detailContent}>
            ...
            <TouchableOpacity
              style={styles.detailItem}
              onPress={() => {
                navigation.navigate("AudioGuideSetting");
              }}
            >
              <View style={styles.optionItem1}>
