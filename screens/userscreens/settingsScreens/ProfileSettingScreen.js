...
export default function ProfileSettingScreen({}) {
  const {
    translations: { ProfileSettingScreenjs: translated },
  ...
  return (
    <View style={styles.container}>
      <View style={styles.topContainer}>
        ...
        <Text style={styles.titleText}>{translated.profile}</Text>
        <View></View>
      </View>
      <ScrollView style={{ marginTop: 30 }}>
        ...
        >
          <View style={styles.selectSubContainer}>
            <Text style={styles.detailItemText}>{translated.Language}</Text>
          </View>
        </TouchableOpacity>
      </ScrollView>
    </View>
